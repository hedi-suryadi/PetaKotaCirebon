...
var southWest = L.latLng(),
    northEast = L.latLng(-6.724674, 108.560457),
...
var map = L.map('map', {
 maxBounds: bounds,
 center: [-6.739917160432219, 108.55281826613908],
 zoom: 15,
 maxZoom: 22,
 minZoom: 10,
...
var popupstmik = new L.Popup({maxWidth : 135, closeOnClick: false, autoClose: false});
    popupstmik.setLatLng([-6.72895830298496, 108.57180391055307]);
    popupstmik.setContent('<p><img src="kraton.jpg" width="100" height="100" style="vertical-align:middle"/> <b>Taman Bukit Kraton Kasepuhan </b> Disini!</p>');
var marker = L.marker([-6.72895830298496, 108.57180391055307], {icon:Icon1}).addTo(custommarker).bindPopup(popupstmik).closePopup();
...
var Icon3 = L.icon({
	   ...
	   popupAnchor: [0, -30]});
var popupstmik = new L.Popup({maxWidth : 135, closeOnClick: false, autoClose: false});
	   popupstmik.setLatLng([-6.707299093924219, 108.55755177301539]);
	   popupstmik.setContent('<p><img src="balaikotacirebon.jpg" width="135" height="135" style="vertical-align:middle"/> <b>Balai Kota Cirebon</b> Disini!</p>');
var marker = L.marker([-6.707299093924219, 108.55755177301539], {icon:Icon3}).addTo(custommarker).bindPopup(popupstmik).closePopup();
...
var popupstmik = new L.Popup({maxWidth : 155, closeOnClick: false, autoClose: true});
      popupstmik.setLatLng([-6.730364132770273, 108.55499295670496]);
      popupstmik.setContent('<p><img src="rsudGunungjaticirebon.jpg" width="155" height="155" style="vertical-align:middle"/> <b>RSUD Gunung Jati Cirebon</b> Disini!</p>');
var marker = L.marker([-6.730364132770273, 108.55499295670496], {icon:Icon4}).addTo(custommarker).bindPopup(popupstmik).closePopup();
...
var popupmasjid = new L.Popup({maxWidth : 135, closeOnClick: false, autoClose: false});
      popupmasjid.setLatLng([-6.721874545505249, 108.56760493201779]);
      popupmasjid.setContent('<p><img src="kratonkanoman.jpg" width="135" height="135" style="vertical-align:middle"/> <b>Kraton Kanoman</b> Disini!</p>');
var marker = L.marker([-6.721874545505249, 108.56760493201779], {icon:Icon5}).addTo(custommarker).bindPopup(popupmasjid).closePopup();
...
var circle1 = L.circle(
   [-6.728544120723939,108.5719753085366],
{
	color: '#800000',
	fillColor: '#00FFFF',
	fillOpacity: 0.3,
	...
	stroke: true,
	radius: 130
}).addTo(circle).bindPopup("<b>Taman Bukit Kraton Kasepuhan</b><br/>Disini!").closePopup();
// ====================Batas Circle Taman Bukit Kraton===========================================================================================================================================================================
var circle2 = L.circle(
   [-6.731256868922685,108.53444556225776],
{
	color: '#800000',
	fillColor: '#00FFFF',
	fillOpacity: 0.3,
...
var circle3 = L.circle(
   [-6.707360540421547,108.55752576169203],
{
   color: '#800000',
   fillcolor: '00FFFF',
   fillOpacity: 0.3,
   ...
   stroke : true,
   radius : 80
}).addTo(circle).bindPopup("<b>Balai Kota Cirebon</b><br/>Disini!").closePopup();
// <=====================Batas Akhir Circle====================================================================================================================================================================================================>
// <=================Batas Data Awal Rectangle (Kotak)================================================================================================================================================================================>
 // Rectangle Data Section
 var rectangle = L.layerGroup();
 var rectangle1 =[
   [-6.7287331200599425,108.55376697626576],
   [-6.731472986719638,108.55597863838943]];
   L.rectangle(rectangle1,{
   color: '#FD1C03', 
   fillColor: '#F433FF', 
   fillopacity: 0.3, 
   weight: 2, 
 }).addTo(rectangle).bindPopup("<b>RUSUD Gunung Jati Cirebon</b><br/>Disini!").closePopup();
//  ============== Batas rectangle 1 rsud gunung jati=====================================================================================
 var rectangle2 =[
   [-6.721650770568729,108.56713049568549],
   [-6.722123276621588,108.5683071292591]];
	L.rectangle(rectangle2, {
	color: '#FD1C03', 
	fillColor: '#F433FF',
	fillOpacity: 0.2,
	weight: 2
}).addTo(rectangle).bindPopup("<b>Alun-Alun Kraton Kanoman</b><br />Disini!").closePopup();
// ==================Batas rectangle 2 kraton kanoman==================================================================================
var rectangle3 =[
   [-6.735046173231268,108.54244586593364], 
   [-6.737518096655762,108.5446597950974]];
